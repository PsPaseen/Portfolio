...
export const LandingPage = () => {
    ...
    <>
        <Topbar />
        <Box sx={{display:'flex', flexDirection:'column' , height:'200px', textAlign:'center', justifyContent:'center' , background: 'linear-gradient(to bottom, #292a33 0%, #373a5c 100%)'}}/>

            <Box sx={{display:'flex', flexDirection:'row' , height:'450px', backgroundColor: '#373A5C', justifyContent:'center', gap:12 }}>
                <motion.div  
                ...
                transition={{
                    ...
                    <Box sx={{display:'flex' ,flexDirection:'column',maxWidth:'834px'}}>
                        <Box sx={{display:'flex' ,flexDirection:'row', gap:2}}>
                            <Typography fontFamily={'Mitr'} fontWeight={'400'} variant="h2" color="white">สวัสดีครับ! ผมชื่อ </Typography>
                            <motion.div whileTap={{scale: 0.95, transition: {duration: 0.3}}} whileHover={{scale: 1.02, transition: {duration: 0.3}}}>
                                <Typography fontFamily={'Mitr'} fontWeight={'500'} variant="h2" color="white">Paseen</Typography>
                            </motion.div>
                        </Box>
                        <motion.div initial={{ opacity: 0, scale: 0.3 }} animate={{ opacity: 1, scale: 1 }} transition={{duration: 1, delay: 0.5,ease: [0, 0.71, 0.2, 1.01], type:'spring' }}>
                            <Box sx={{display:'flex',flexDirection:'column', gap:4}}>
                                <div>
                                    <Typography fontFamily={'Mitr'} fontWeight={'200'} variant="h6" color="white">เรียนจบจากมหาวิทยาลัยธรรมศาสตร์รังสิต คณะวิทยาศาสตร์และเทคโนโลยี สาขาวิทยาการคอมพิวเตอร์ด้วย<span style={{fontWeight:'300'}}>เกียรตินิยมอันดับ2🥈 </span>มีความสามารถในการออกแบบพัฒนาเว็บไซต์ด้วยเทคโนโลยีที่ทันสมัย💡 และพร้อมท้าทายเรียนรู้สิ่งใหม่ๆอยู่เสมอ!🔥 </Typography>   
                                        <Box sx={{display:'flex',flexDirection:'row',gap:1.5, paddingTop: 3}}>
                                ...
                                <Box sx={{display:'flex' ,flexDirection:'row', gap:2}}>   
                                    ...
                                    <motion.div whileTap={{scale: 0.95, transition: {duration: 0.3}}} whileHover={{scale: 1.02, transition: {duration: 0.3}}}>
                                        <Button variant="text" color="inherit" sx={{fontFamily:'Mitr', height:'36.5px', width:'80px',fontSize:'12px',textTransform: 'none'}}><img  style={{height: '20px',width:'20px',marginRight:4}} src={imageGit}/>Github</Button>
                                    </motion.div>
                                </Box>  
                            </Box>
                ...
                transition={{
                    ...
                    <motion.div whileTap={{scale: 0.95, transition: {duration: 0.3}}} whileHover={{scale: 1.02, transition: {duration: 0.3}}}>
                        <Avatar variant="rounded" sx={{height:'400px',width:'400px', boxShadow:'0px 0px 4px #fff'}} src={Paseen}/>
                    </motion.div>
                </motion.div>
            </Box>
        ...
        <Box sx={{display:'flex', flexDirection:'column' , height:'200px', textAlign:'center', justifyContent:'center' , background: 'linear-gradient(to bottom, #373a5c 0%, #292a33 100%)'}}/>
             <Box sx={{display:'flex', flexDirection:'column' , height:'650px', backgroundColor: '#292A33' , textAlign:'center'}}>
                <motion.div  
                            initial="offscreen"
        ...
        <Box sx={{display:'flex', flexDirection:'column' , height:'250px', textAlign:'center', justifyContent:'center' , background: 'linear-gradient(to bottom, #292a33 0%, #373a5c 100%)'}}/>
            <Box sx={{display:'flex', flexDirection:'column' , height:'900px', backgroundColor: '#373A5C' , textAlign:'center', justifyContent:'center'}}>
                <motion.div  
                                initial="offscreen"
                                whileInView="onscreen"
                                viewport={{ amount: 0.2 , once: true }}
                        ...
                        <Box sx={{display:'flex', flexDirection:'row',flexWrap:'wrap' ,gap:2, pt: 12 ,justifyContent:'center', alignItems:'center' }}>
                                <CardProject large={true} name="ฝึกงานสหกิจศึกษา บริษัทตลาดหลักทรัพย์แห่งประเทศไทย" info="ฝึกงานสหกิจศึกษาระยะเวลา 6 เดือน ตั้งแต่ กรกฏาคม 2567 ถึง ธันวาคม 2567 ได้รับหน้าที่เป็น Full-Stack Developer ได้รับมอบหมายโปรเจคพัฒนาและย้ายระบบ Back-Office จาก Angular เป็น React" imageURL={imageSet}/>
        ...
        <Box sx={{display:'flex', flexDirection:'column' , height:'200px', textAlign:'center', justifyContent:'center' , background: 'linear-gradient(to bottom, #373a5c 0%, #292a33 50%)'}}/>                    
        <Box sx={{display:'flex', flexDirection:'column' , height:'400px', backgroundColor: '#292A33',alignItems:'center'}}>
                <motion.div  
                            initial="offscreen"
                            whileInView="onscreen"
                            viewport={{ amount: 0.2 , once: true }}
                ...
                <Box sx={{display:'flex', flexDirection:'column', pt:6 , textAlign:'center',pl:8,gap:3 }}>        
                    <Box sx={{display:'flex', flexDirection:'row', gap:1}}>
                        ...
                        <Typography sx={{width:'111px'}} fontFamily={'Mitr'} fontWeight={'400'} variant="h6" color="white">Tel</Typography>
                        <Typography sx={{pl: 6}} fontFamily={'Mitr'} fontWeight={'500'} variant="h6" color="white">083-311-9223</Typography>

                    </Box>
                    <Box sx={{display:'flex', flexDirection:'row', gap:1}}>
                        <EmailIcon sx={{height:'30px',width:'30px'}}/>
                        <Typography sx={{width:'111px'}} fontFamily={'Mitr'} fontWeight={'400'} variant="h6" color="white">Email</Typography>
                        <Typography sx={{pl: 6}} fontFamily={'Mitr'} fontWeight={'500'} variant="h6" color="white">paseen.san@gmail.com</Typography>
                    </Box>
                    <Box onClick={onClickGit} sx={{display:'flex', flexDirection:'row', gap:1,cursor:'pointer'}}>
                        ...
                        <Typography sx={{width:'111px'}} fontFamily={'Mitr'} fontWeight={'400'} variant="h6" color="white">Github</Typography>
                        <Typography sx={{pl: 6}} fontFamily={'Mitr'} fontWeight={'500'} variant="h6" color="white">PsPaseen</Typography>
                    </Box>
                </Box>
            </motion.div>
        </Box>
